...
Route::middleware(['auth', 'user-access:customer'])->group(function () {
    ...
    Route::get('/costumer/produk/create', [ProdukCustomerController::class, 'ketambahproduk']);
    Route::post('/costumer/produk/tambah', [ProdukCustomerController::class, 'storeCustomer']);
    Route::get('/costumer/produk/lihat', [ProdukCustomerController::class, 'indexCustomer'])->name('customer.list_produk');
    Route::get('/costumer/pesanan/download/{id}', [PesananCustomerController::class, 'download3d'])->name('customer.download3d');
});
